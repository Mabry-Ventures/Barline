...
[![Download](https://img.shields.io/badge/download-macOS%2026%20prerelease-brightgreen?style=flat-square)](https://github.com/lxy1992/Ice/releases/tag/0.11.13-macos26.2)
...
> [!NOTE]
> This fork includes macOS 26 compatibility work and is currently distributed as a prerelease. Download `0.11.13-macos26.2` [here](https://github.com/lxy1992/Ice/releases/tag/0.11.13-macos26.2). Automatic updates remain disabled until this fork has its own signed update feed.
...
Download the "Ice.zip" file from the [`0.11.13-macos26.2` prerelease](https://github.com/lxy1992/Ice/releases/tag/0.11.13-macos26.2) and move the unzipped app into your `Applications` folder.
