...
| 4. Fixture and local CI | Lead; delegated validation | Implemented; new exact-head rerun pending | M3 | real fixture/test targets and test plan; explicit non-focus lane excludes production app activation; source changes require regeneration |
