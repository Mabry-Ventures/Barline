...
| Release/install/update | Clean archive, signing, notarization, stapling, Gatekeeper, Sparkle, and SBOM gates | Build 37 passed exact-head signed packaging including the disk image, notarization, independent verification, and a signed build-36-to-37 Sparkle update with cold launch, and was published as `v1.0.12`; clean installation on a second Mac was maintainer-reported passing after publication; installed click journeys were not run |
