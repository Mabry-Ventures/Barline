...
require_count "$PROJECT" 'CURRENT_PROJECT_VERSION = 1123;' 4 \
    'app and XPC build number is 1123 in Debug and Release'
...
require_count "$README" 'https://github.com/lxy1992/Ice/releases/tag/0.11.13-macos26.2' 3 \
