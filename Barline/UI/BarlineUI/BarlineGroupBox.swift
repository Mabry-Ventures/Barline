//
//  BarlineGroupBox.swift
//  Barline
//

import SwiftUI

struct BarlineGroupBox<Header: View, Content: View, Footer: View>: View {
    ...
    init(
        padding: EdgeInsets = .barlineGroupBoxDefaultPadding,
...
extension EdgeInsets {
    /// The default padding for an ``BarlineGroupBox``.
    static let barlineGroupBoxDefaultPadding = EdgeInsets(all: 12)
}
