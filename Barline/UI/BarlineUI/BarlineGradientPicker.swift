...
struct BarlineGradientPicker<Label: View>: View {
    @Binding private var gradient: BarlineGradient
    ...
    init(
        gradient: Binding<BarlineGradient>,
...
private struct BarlineGradientPickerRoot: View {
    @Environment(\.isEnabled) private var isEnabled

    @Binding var gradient: BarlineGradient
    ...
    private func gradientChanged(from oldValue: BarlineGradient, to newValue: BarlineGradient) {
...
private struct BarlineGradientPickerHandle: View {
    @Binding var gradient: BarlineGradient
    @Binding var selection: Int?
    ...
    private var stop: BarlineGradient.ColorStop? {
