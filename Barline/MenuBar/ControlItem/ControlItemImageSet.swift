...
extension ControlItemImageSet {
    /// The default image set for the Barline icon.
    static let defaultBarlineIcon = ControlItemImageSet(
        name: .dot,
        hidden: .catalog("DotFill"),
        visible: .catalog("DotStroke")
    )

    /// The image sets that the user can choose to display in the Barline icon.
    static let userSelectableBarlineIcons = [
        ControlItemImageSet(
            name: .arrow,
        ...
        ControlItemImageSet(
            name: .barlineControl,
            hidden: .catalog("BarlineControlStroke"),
            visible: .catalog("BarlineControlFill")
        ),
        ControlItemImageSet(
            name: .sunglasses,
