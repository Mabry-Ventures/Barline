...
struct MenuBarAppearanceEditor: View {
    ...
    private var cannotEdit: some View {
        Text("Barline cannot edit the appearance of automatically hidden menu bars.")
            .font(.title3)
...
private struct UnlabeledPartialEditor: View {
    ...
    private var tintPicker: some View {
        LabeledContent("Tint") {
            HStack {
                BarlinePicker("Tint", selection: $configuration.tintKind) {
