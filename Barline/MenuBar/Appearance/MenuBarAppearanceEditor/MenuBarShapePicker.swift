...
struct MenuBarShapePicker: View {
    ...
    private var shapeKindPicker: some View {
        BarlinePicker("Shape Kind", selection: $configuration.shapeKind) {
...
private struct MenuBarFullShapePicker: View {
...
private struct MenuBarSplitShapePicker: View {
...
extension MenuBarFullShapePicker: @MainActor Equatable {
    static func == (lhs: Self, rhs: Self) -> Bool {
        lhs.info == rhs.info
    }
}

extension MenuBarSplitShapePicker: @MainActor Equatable {
    static func == (lhs: Self, rhs: Self) -> Bool {
        lhs.info == rhs.info
    }
}
