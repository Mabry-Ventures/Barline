...
struct MenuBarAppearanceConfigurationV1: Hashable {
    ...
    var tintGradient: BarlineGradient
    ...
    static func migrate(encoder: JSONEncoder, decoder: JSONDecoder) throws -> Self {
        ...
        if let data = Defaults.data(forKey: .menuBarAppearanceConfiguration) {
            ...
            if let borderColorData = Defaults.data(forKey: .menuBarBorderColor) {
                configuration.borderColor = try decoder.decode(BarlineColor.self, from: borderColorData).cgColor
            }
            if let tintColorData = Defaults.data(forKey: .menuBarTintColor) {
                configuration.tintColor = try decoder.decode(BarlineColor.self, from: tintColorData).cgColor
            }
            if let tintGradientData = Defaults.data(forKey: .menuBarTintGradient) {
                configuration.tintGradient = try decoder.decode(BarlineGradient.self, from: tintGradientData)
            }
...
extension MenuBarAppearanceConfigurationV1: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        try self.init(
            ...
            borderColor: container.decodeIfPresent(BarlineColor.self, forKey: .borderColor)?.cgColor ?? Self.defaultConfiguration.borderColor,
            ...
            tintColor: container.decodeIfPresent(BarlineColor.self, forKey: .tintColor)?.cgColor ?? Self.defaultConfiguration.tintColor,
            tintGradient: container.decodeIfPresent(BarlineGradient.self, forKey: .tintGradient) ?? Self.defaultConfiguration.tintGradient
        )
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(BarlineColor(cgColor: borderColor), forKey: .borderColor)
        ...
        try container.encode(BarlineColor(cgColor: tintColor), forKey: .tintColor)
